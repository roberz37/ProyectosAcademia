...
// MODIFICAR ACA
class GananciaCachavrolet {
  private $autos;
  private $totalCachavrolet=0;
  
  public function __construct($autos){
      $this->autos=$autos;
  }
  public function agregarAutos($idReferencia, $marca, $modelo, $anio, $precio){
      return $this->autos->agregarAutos($idReferencia, $marca, $modelo, $anio, $precio);
  }
  public function mostrarAutosDeMarca($marca){
  ...
  public function venderAutoMarca($marca){
      $auxiliar= $this->totalGanado();
      $venta= $this->autos->venderAutoMarca($marca);
      if ($marca=='Cachavrolet'){
          $this->totalCachavrolet+=$this->totalGanado()-$auxiliar;
      }
      return $venta;
  }

  public function totalGanado(){
      return $this->autos->totalGanado();
  }

  public function totalGanadoCachavrolet(){
      return $this->totalCachavrolet;
  }
  public function CantidadCachavrolet(){
    return $this->autos->cantidadCachavrolet();
  }
}
class CantidadCachavrolet {
  private $autos;
  private $cantidadCachavrolet=0;
  ...
  public function CantidadCachavrolet(){
      return $this->cantidadCachavrolet;
  }

}
  
$concesionario = new GananciaCachavrolet(new CantidadCachavrolet(new Concesionaria()));
// HASTA ACA
...
// MODIFICAR ACA
echo $concesionario->totalGanadoCachavrolet();
echo $concesionario->CantidadCachavrolet();
// Hasta aca